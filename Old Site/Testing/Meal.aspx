<%@ Page Language="C#" AutoEventWireup="true" Inherits="Meal" Codebehind="Meal.aspx.cs" %>
...
<body>
    ...
    <div>
        <table style="width: 425px">
            <thead title="Add a new Meal"/>
             ...
             <tr>
               <td style="width:150px">
                     <asp:Label ID="Label3" runat="server" Text="Select the show:"></asp:Label>
                </td>
            ...
            <tr>
                <td style="width:150px">
                    <asp:Label ID="Label1" runat="server" Text="Dessert Name:"></asp:Label>
                </td>
            ...
            <tr>
                <td style="width:150px">
                     <asp:Label ID="Label2" runat="server" Text="Dessert Description:"></asp:Label>
                </td>
                  <td style="width:250px">
            ...
            <tr>
                <td colspan="2" style="text-align:right;">
                    <asp:Button ID="btnAdd" runat="server" Text="Add Meal" onclick="btnAdd_Click" />
                </td>
            </tr>
