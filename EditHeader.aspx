<%@ Page Language="C#" MasterPageFile="~/Template.master" AutoEventWireup="true"
    CodeFile="EditHeader.aspx.cs" Inherits="EditHeader" Title="Edit Header" ValidateRequest="false" %>
        ...
        <table>
            <tr>
                <td style="width: 900px; height: 500px; text-align: left; vertical-align: top; padding: 15px;
                    ...
                    <br />
                    <center>
                        <%--<cc1:richtexteditor id="rteColumn" backcolor="#6FAEE7" width="700" height="200" runat="server"
                            dommode="False"></cc1:richtexteditor>--%>
                        <FCKeditorV2:FCKeditor ID="rteColumn" ToolbarSet="STUCustom" Width="700px" Height="350px"
